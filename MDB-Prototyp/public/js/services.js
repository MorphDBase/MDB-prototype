...
MDBServices.factory('NotificationService', function ($q, $rootScope, $timeout, AlertService) {
    ...
    /***
     mdb_info_message: message.MDB_UIAP_0000000387
     */
    ...
    /***
     mdb_error_message: message.MDB_UIAP_0000000388
     */
...
MDBServices.factory('AuthService', function ($q, $rootScope, $timeout, $cookies, $http, RandomNumberService, NotificationService) {
    ...
    function register(form) {
        ...
        var username = form.MDB_DATASCHEME_0000000688.$modelValue;
        var password = form.MDB_DATASCHEME_0000000686.$modelValue;
        ...
        /*var register_values = {};
         ...
         if (value.$name != 'MDB_DATASCHEME_0000000686') {
    ...
    function authenticate(form) {
        ...
        var username = form.MDB_DATASCHEME_0000000781.$modelValue;
        var password = form.MDB_DATASCHEME_0000000783.$modelValue;
    ...
    function login(mdbusername, mdbueid, mdbueiduri, ws_message) {
        ...
        if (ws_message.validation_ref == "MDB_DATASCHEME_0000000780" && ws_message.validation_status) {
            user = true;
    ...
    $rootScope.$on('WSLoginFeedbackMessage', function (event, args) {
        /*{
         ...
         "mdbueid": "a1b2c3d4",
         "data": [{
         "MDB_DATASCHEME_0000000780": {
         "valid": "true"
         }}],
         "html_form": "GUI_COMPONENT_0000000175",
         "localID": "MDB_DATASCHEME_0000000780"
         }*/
    ...
    $rootScope.$on('WSNewAuthCompositionMessage', function (event, args) {
        ...
        //alert('socket_message_data["MDB_UIAP_0000000193"] == "GUI_COMPONENT_0000000058"\n' + JSON.stringify(socket_message_data["MDB_UIAP_0000000193"]));
        ...
        if (socket_message_data["MDB_UIAP_0000000193"] == "GUI_COMPONENT_0000000058") {
            ...
            for (var i = 0; i < authPanelRepresentation.length; i++) {
                for (var entry in authPanelRepresentation[i]) {
                    ...
                    if (entry == 'MDB_UIAP_0000000193' || authPanelRepresentation[i][entry] == 'GUI_COMPONENT_0000000058') {
                        var authSimplePanel = authPanelRepresentation[i]['MDB_GUI_0000000040'];
                        ...
                        for (var j = 0; j < authSimplePanel.length; j++) {
                            ...
                            for (var sec in authSimplePanelSections) {
                                ...
                                // literal
                                if (authSimplePanelSections[sec] == 'MDB_GUI_0000000072') {
                                    //"MDB_UIAP_0000000019": "MDB_GUI_0000000072"
                                    authSimplePanelSections['html_input_type'] = 'text';
                                }
                                //password
                                else if (authSimplePanelSections[sec] == 'MDB_GUI_0000000354') {
                                    // "MDB_UIAP_0000000019": "MDB_GUI_0000000354" (== input type password)
                                    // "localID": "MDB_DATASCHEME_0000000686", (signup - New password)
                                    // "localID": "MDB_DATASCHEME_0000000783", (login - Password)
                                    authSimplePanelSections['html_input_type'] = 'password';
                                }

                                // email (== input type email)
                                else if (authSimplePanelSections[sec] == 'MDB_GUI_0000000080') {
                                    //"MDB_UIAP_0000000019": "MDB_GUI_0000000080" (== input type email)
                                    //"localID": "MDB_DATASCHEME_0000000688" (signup - email)
                                    //"localID": "MDB_DATASCHEME_0000000687" (signup - reenter email)
                                    //"localID": "MDB_DATASCHEME_0000000781" (login - email)
                                ...
                                if (sec == 'MDB_GUI_0000000040') {
                                    ...
                                    for (var k = 0; k < authSimplePanelSection.length; k++) {
                                        ...
                                        for (var en in authSimplePanelSec) {
                                            ...
                                            // literal
                                            if (authSimplePanelSec[en] == 'MDB_GUI_0000000072') {
                                                //"MDB_UIAP_0000000019": "MDB_GUI_0000000072"
                                                authSimplePanelSec['html_input_type'] = 'text';
                                            }
                                            //password
                                            else if (authSimplePanelSec[en] == 'MDB_GUI_0000000354') {
                                                // "MDB_UIAP_0000000019": "MDB_GUI_0000000354" (== input type password)
                                                // "localID": "MDB_DATASCHEME_0000000686", (signup - New password)
                                                // "localID": "MDB_DATASCHEME_0000000783", (login - Password)
                                            ...
                                            // email
                                            else if (authSimplePanelSec[en] == 'MDB_GUI_0000000080') {
                                                //"MDB_UIAP_0000000019": "MDB_GUI_0000000080" (== input type email)
                                                //"localID": "MDB_DATASCHEME_0000000688" (signup - email)
                                                //"localID": "MDB_DATASCHEME_0000000687" (signup - reenter email)
                                                //"localID": "MDB_DATASCHEME_0000000781" (login - email)
            ...
            if (socket_message.load_page_localID == 'Ontologies/GUIComponent#GUI_COMPONENT_0000000143') {
                authPanelRepresentation[0].mdbForm_label = "Sign up";
            }
            else if (socket_message.load_page_localID == 'Ontologies/GUIComponent#GUI_COMPONENT_0000000175') {
...
MDBServices.factory('WsService', function ($q, $rootScope,  $http, $location, $timeout, $cookies, $websocket) {
    ...
    var ws_url = 'wss://fuseki.morphdbase.de/javacode/echo';
    var ws_protocol = [];
    var ws_options = [];
    ...
    ws_socket.onMessage(function (event) {
        ...
        if (message.connectSID == connectSID) {
            ...
            else if (message[$rootScope.keywordKnownResourceA] && !mdbKnownResA && message.localID != "MDB_DATASCHEME_0000000947") {
            ...
            //// SHOW MDB messages //////////////////////////////////////////
            if (message.MDB_UIAP_0000000387) {
                console.info('WSMDBInfoMessage: ' + message.MDB_UIAP_0000000387);
                $rootScope.$emit('WSMDBInfoMessage', {
                    mdb_info_message: message.MDB_UIAP_0000000387 // MDB info-message
                });
            }
            if (message.MDB_UIAP_0000000388) {
                console.info('WSMDBErrorMessage: ' + message.MDB_UIAP_0000000388);
                $rootScope.$emit('WSMDBErrorMessage', {
                    mdb_error_message: message.MDB_UIAP_0000000388 // MDB error-message
                });
            }
            ...
            if (message.load_page_localID) {
                ...
                if (message.load_page_localID.indexOf("Ontologies/GUIComponent#GUI_COMPONENT_0000000175") > -1 || message.load_page_localID.indexOf("Ontologies/GUIComponent#GUI_COMPONENT_0000000143") > -1) {
                ...
                // TODO: remove second condition after next reset of the jena tdb"
                else if (message.load_page_localID.indexOf("MDB_DATASCHEME_0000000703") > -1 || message.load_page_localID.indexOf("MDB_DATASCHEME_0000000733") > -1) {
                ...
                // "load_page_localID": "resource/de46dd64-20170807-md-34-d_1_1#GUI_COMPONENT_0000000325",
                else if (message.load_page_localID.indexOf("GUI_COMPONENT_0000000325") > -1) {
                ...
                /*
                 {"connectSID":"s:42-HALLOHIERALARMEINS1ELF-TTESTT.SANDRASGANZPERSOENLICHEMDBPROTOTYPSESSIONID",
                 "mdbueid":"272b7f79",
                 "http://www.morphdbase.de/Ontologies/MDB/MDB_GUI#MDB_GUI_0000000412":"http://www.morphdbase.de/resource/272b7f79#MDB_CORE_0000000568_35",
                 "http://www.morphdbase.de/Ontologies/MDB/MDB_GUI#MDB_GUI_0000000411":"http://www.morphdbase.de/resource/272b7f79#TimeInterval_35",
                 "data":[   {"withStatus":"MDB_CORE_0000000115","entryLabel":"Klaus Maiers new Entry","MDB_CORE_0000000602":"MDB_CORE_0000000611","MDB_GUI_0000000288":"Klaus","MDB_GUI_0000000088":"Maier","uri":"http://www.morphdbase.de/resource/caab6b18-20171019-md-2-d_1_1"},
                            {"withStatus":"MDB_CORE_0000000115","MDB_CORE_0000000602":"MDB_CORE_0000000611","MDB_GUI_0000000288":"Klaus","MDB_GUI_0000000088":"Maier","uri":"http://www.morphdbase.de/resource/caab6b18-20171019-md-1-d_1_1"},
                            {"withStatus":"MDB_CORE_0000000115","MDB_CORE_0000000602":"MDB_CORE_0000000611","uri":"http://www.morphdbase.de/resource/de46dd64-20171019-md-1-d_1_1"},{"withStatus":"MDB_CORE_0000000115","MDB_CORE_0000000602":"MDB_CORE_0000000611","uri":"http://www.morphdbase.de/resource/272b7f79-20171018-md-1-d_1_1"},
                            {"withStatus":"MDB_CORE_0000000115","MDB_CORE_0000000602":"MDB_CORE_0000000611","uri":"http://www.morphdbase.de/resource/de46dd64-20171018-md-1-d_1_1"}],
            ...
            // response to login button
                ...
                $rootScope.$broadcast('WSLoginFeedbackMessage', {
                    ...
                    validation_status: message.data[0]["MDB_DATASCHEME_0000000780"].valid,
                    validation_message: "Login successful!",
                    validation_error: message.data[0]["MDB_DATASCHEME_0000000780"].MDB_UIAP_0000000388,
                    mdbueid: message.mdbueid,
                    mdbKnownResA: message[$rootScope.keywordKnownResourceA],
                    mdbKnownResB: message[$rootScope.keywordKnownResourceB],
                    connectSID: message.connectSID
                ...
                // TODO: remove as soon as Prototype is finished
                if (message.data[0]["MDB_DATASCHEME_0000000780"].MDB_UIAP_0000000388) {
                    console.warn("MDB error message: " + message.data[0]["MDB_DATASCHEME_0000000780"].MDB_UIAP_0000000388);
                }
                else {
                    console.info("Login status: " + message.data[0]["MDB_DATASCHEME_0000000780"].valid);
                }
            }
            // response to register button
            else if (message.localID == "MDB_DATASCHEME_0000000684") {
                ...
                // TODO: remove as soon as Prototype is finished
                if (message.data[0]["MDB_DATASCHEME_0000000684"].MDB_UIAP_0000000388) {
                    console.warn("MDB error message: " + message.data[0]["MDB_DATASCHEME_0000000684"].MDB_UIAP_0000000388);
                }
                else {
                    console.info("Registration status: " + message.data[0]["MDB_DATASCHEME_0000000684"].valid);
                }
            }
            // response to logout button
            else if (message.localID == "MDB_DATASCHEME_0000000947") {
                $rootScope.$broadcast('WSLogoutFeedbackMessage', {
                    socket_message: message,
                    validation_ref: message.localID,
                    validation_status: message.data[0]["MDB_DATASCHEME_0000000947"].valid,
                    validation_message: "Logout successful!",
                    validation_error: message.data[0]["MDB_DATASCHEME_0000000947"].MDB_UIAP_0000000388,
                    mdbueid: message.mdbueid,
                    mdbKnownResA: message[$rootScope.keywordKnownResourceA],
                    mdbKnownResB: message[$rootScope.keywordKnownResourceB],
                    connectSID: message.connectSID,
                ...
                // TODO: remove as soon as Prototype is finished
                if (message.data[0]["MDB_DATASCHEME_0000000947"].MDB_UIAP_0000000388) {
                    console.warn("MDB error message: " + message.data[0]["MDB_DATASCHEME_0000000947"].MDB_UIAP_0000000388);
                }
                else {
                    console.info("Registration status: " + message.data[0]["MDB_DATASCHEME_0000000947"].valid);
                }
            }
            ...
            if (message.load_overlay) {
                ...
                //// SPECIMEN WIDGET
                if (message.widget.indexOf("GUI_COMPONENT_0000000185") > -1) {
                    $rootScope.$emit('WSNewEntryModalCompositionMessage', {
                        ...
                        html_form: message.html_form,
                        mdbueid_uri: message.mdbueid_uri,
                        notification: message.MDB_UIAP_0000000387,
                        localID: message.localID
                    });
                }
                else {
            ...
            if (!$cookies.get('currentUser')){
                ...
                $http.get('/user/getconnectsid')
                    ...
                    .then(function (result) {
                        ...
                        sendGenerateDoc('GUI_COMPONENT_0000000175');
                    })
                    // handle error
                    .catch(function (data) {
    ...
    function sendCheckAutocomplete(mdbformid, key, value, autocompleteontology, autocompletesubontology) {
        ...
        /*
         ...
         "connectSID": "s:42-HALLOHIERALARMEINS1ELF-TTESTT.SANDRASGANZPERSOENLICHEMDBPROTOTYPSESSIONID",
         "value": "bac",
         "MDB_UIAP_0000000413": "http://www.morphdbase.de/Ontologies/MDB/MDBCore#MDB_CORE_0000000032",
         "http://www.morphdbase.de/Ontologies/MDB/MDB_GUI#MDB_GUI_0000000411": "http://www.morphdbase.de/resource/6cc9ca2f#TimeInterval_67",
         "http://www.morphdbase.de/Ontologies/MDB/MDB_GUI#MDB_GUI_0000000412": "http://www.morphdbase.de/resource/6cc9ca2f#MDB_CORE_0000000568_67"
         }
         */
        ...
        if (autocompleteontology) {
            check_autocomplete['MDB_UIAP_0000000413'] = autocompleteontology;
        }
        if (autocompletesubontology) {
            check_autocomplete['MDB_UIAP_0000000578'] = autocompletesubontology;
        }
        if (mdbKnownResA) {
...
MDBServices.factory('MDBDocumentService', function ($q, $rootScope, $cookies, $http, $timeout, $location, WsService, AuthService) {
    ...
    function setInput(docitems, deferred, input) {
        ...
        if (docitems) {
            angular.forEach(docitems, function (value, key, obj) {
                ...
                if (key == 'MDB_GUI_0000000040' && obj.MDB_GUI_0000000040.length > 0) {
                    setInput(value);
                }
                ...
                else if (key == 'MDB_CORE_0000000460' || key == 'MDB_CORE_0000000461' || key == 'MDB_CORE_0000000462' || key == 'MDB_CORE_0000000454' || key == 'MDB_UIAP_0000000260') {
                    //console.info("1st loop: MDB_CORE_0000000460... - key   - " + JSON.stringify(key) + " value - " + JSON.stringify(value));
                    input[obj.localID] = value;
                }
                // has selected resource
                else if (key == 'MDB_GUI_0000000445') {
                    //console.info("2nd loop: has selected resource" + "\nkey     - " + JSON.stringify(key) + "\nvalue   - " + JSON.stringify(value) + "\nobj.MDB_UIAP_0000000023   - " + JSON.stringify(obj.MDB_UIAP_0000000023));
                    // input restricted to subclasses of
                    if (obj.MDB_UIAP_0000000023){
                        angular.forEach(obj.MDB_UIAP_0000000023, function (val, kee, ob) {
                    ...
                    else if (obj.MDB_UIAP_0000000118){
                        angular.forEach(obj.MDB_UIAP_0000000118, function (val, kee, ob) {
                            if(val.selValue == value){
                ...
                // has Boolean value [BOOLEAN]
                else if (key == 'MDB_UIAP_0000000214') {
                    if (value == "true"){
                    ...
                    // radio buttons
                    //if (obj.MDB_UIAP_0000000193 === "GUI_COMPONENT_0000000188"){
                    //    input[obj.localID] = value;
                    //}
                    //else{
                    //    if (value == "true"){
                ...
                angular.forEach(value, function (value, key, obj) {
                    ...
                    //  has user/GUI input [value_A] || has user/GUI input [value_B] || has user/GUI input [value_C] || has user/GUI input [input_A] || sign up comment
                        ...
                        //console.info("2nd loop: MDB_CORE_0000000460... - key   - " + JSON.stringify(key) + " value - " + JSON.stringify(value));
                        input[obj.localID] = value;
                    }
                    // has selected resource
                    else if (key == 'MDB_GUI_0000000445') {
    ...
    function submitInputData(mdbformid, form, key, value, mdbpartid, mdbactivetab) {
        ...
        // load spinner
        if (key === "MDB_DATASCHEME_0000000695" || key === "MDB_DATASCHEME_0000002104") { // TODO: find a better way to do this
        ...
        if (key === "MDB_DATASCHEME_0000000695" || key === "MDB_DATASCHEME_0000002104"){
            $rootScope.$broadcast('MDBDocumentService_doc_loading_update', {doc_loading: true});
            docLoading = true;
        }
        // if password, send "buffalo"
        if (key == 'MDB_DATASCHEME_0000000783' || key == 'MDB_DATASCHEME_0000000686') {
        ...
        angular.forEach(form, function (val, key) {
            if (typeof val === 'object' && val.hasOwnProperty('$modelValue')) {
                if (!(val.$modelValue == null)) {
                    // if password
                    if (val.$name == 'MDB_DATASCHEME_0000000783' || val.$name == 'MDB_DATASCHEME_0000000686') {
                        // TODO: A long time ago in a galaxy far far away, we may change this workflow and send the password to websocket.
        ...
        // if login button
        if (key == "MDB_DATASCHEME_0000000780" && mdbformid == 'Ontologies/GUIComponent#GUI_COMPONENT_0000000175') {
            ...
            AuthService.authenticate(form)
                ...
                .then(function (data) {
                    ...
                    // WsService.sendGenerateDocToWebsocket('GUI_COMPONENT_0000000143');
                    //TODO: löschen!
                ...
                .catch(function (fallback) {
                    ...
                    $('#MDB_DATASCHEME_0000000780').effect("shake", { times: 5, distance: 2 }, 300);
                    //$('#MDB_DATASCHEME_0000000780').removeClass("btn-default").addClass("btn-danger");
                    //TODO: löschen!
                    //console.log("MDBDocumentService - submitAuthData - authentication catch: " + "\nWhut? - " + fallback);
                });
        }
        // if register button
        else if (key == "MDB_DATASCHEME_0000000684" && mdbformid == 'Ontologies/GUIComponent#GUI_COMPONENT_0000000143') {
            ...
            AuthService.register(form)
                ...
                // handle error
                .catch(function (fallback) {
                    $('#MDB_DATASCHEME_0000000684').effect("shake", { times: 5, distance: 2 }, 300);
                    //$('#MDB_DATASCHEME_0000000684').removeClass("btn-default").addClass("btn-danger");
                    //TODO: löschen!
                    console.log("MDBDocumentService - submitAuthData - register catch: " + "\nWhut? - " + JSON.stringify(fallback));
                });
        }
        // if first register email
        else if (key == "MDB_DATASCHEME_0000000688" && value) {
            ...
            if (form["MDB_DATASCHEME_0000000687"].$modelValue) {
                WsService.sendCheckInputToWebsocket(mdbformid, "MDB_DATASCHEME_0000000687", form["MDB_DATASCHEME_0000000687"].$modelValue, key_data, null, mdbpartid, mdbactivetab);
            }
        }
        // if second register email
        else if (key == "MDB_DATASCHEME_0000000687" && value) {
            WsService.sendCheckInputToWebsocket(mdbformid, key, value, key_data, null, mdbpartid, mdbactivetab);

            // TODO: Workaround: if input is second register email => check first register email again
            if (form["MDB_DATASCHEME_0000000688"].$modelValue) {
                WsService.sendCheckInputToWebsocket(mdbformid, "MDB_DATASCHEME_0000000688", form["MDB_DATASCHEME_0000000688"].$modelValue, key_data, null, mdbpartid, mdbactivetab);
            }
        }
        // if any other input
        else {
    ...
    function submitAuthData(mdbformid, form, key, value) {
        ...
        angular.forEach(form, function (value, key) {
            if (typeof value === 'object' && value.hasOwnProperty('$modelValue')) {
                // if password
                if (value.$name == 'MDB_DATASCHEME_0000000783' || value.$name == 'MDB_DATASCHEME_0000000686') {
                    // TODO: A long time ago in a galaxy far far away, we may change this workflow and send the password to websocket.
                    if (value.$modelValue) {
                ...
                // sign up checkbox
                else if (value.$name == 'MDB_DATASCHEME_0000002670') {
                    if (value.$modelValue) {
        ...
        // first register email
            ...
            if (form["MDB_DATASCHEME_0000000687"].$modelValue) {
                WsService.sendCheckInputToWebsocket(mdbformid, "MDB_DATASCHEME_0000000687", form["MDB_DATASCHEME_0000000687"].$modelValue, key_data, null);
            }
        }
        // second register email
            ...
            // workaround, both email input fields should be checked
            if (form["MDB_DATASCHEME_0000000688"].$modelValue) {
                WsService.sendCheckInputToWebsocket(mdbformid, "MDB_DATASCHEME_0000000688", form["MDB_DATASCHEME_0000000688"].$modelValue, key_data, null);
            }
        }
        // if any other input
        else {
