...
MDBControllers.controller('HeaderCtrl', function ($scope, $rootScope, $log, $http, $location, $cookies, $timeout, NotificationService, AlertService, AuthService, MDBDocumentService, WsService) {
    ...
    $scope.gotoMyMDB = function (formname, form, key, value) {
        ...
        angular.forEach(form, function (value, key) {
            if (typeof value === 'object' && value.hasOwnProperty('$modelValue')) {
                ...
                if (value.$name == 'MDB_DATASCHEME_0000000782' || value.$name == 'MDB_DATASCHEME_0000000686') { // except password
    ...
    $scope.logout = function () {
        ...
        WsService.sendCheckInputToWebsocket("MY_DUMMY_LOGOUT_0000000001", "MDB_DATASCHEME_0000000947", null, null, $scope.currentUEID, null);
    ...
    // submitCreate("MY_DUMMY_DESCRIPTION_0000000001", forms.mdbCreate, "MDB_DATASCHEME_0000002104")
...
MDBControllers.controller('WebsocketCtrl', function ($scope, $rootScope, $log, $http, $location, AuthService, NotificationService, $cookies, WsService) {
    ...
    $scope.sendGenerateDocRequest = function (doc) {
        ...
        if (doc == "login") {
            $scope.WsService.sendGenerateDocToWebsocket('GUI_COMPONENT_0000000175');
        }
        if (doc == "register") {
            $scope.WsService.sendGenerateDocToWebsocket('GUI_COMPONENT_0000000143');
        }
    };
...
MDBControllers.controller('PartAnnotationCtrl', function ($scope, $rootScope, $log, $http, $location, AuthService, NotificationService, $cookies, $timeout, WsService) {
    ...
    ///////////////////////////////////////////////////////////////////////////
        ...
        //{
        //    "MDB_GUI_0000000042": 1,
        //    "localID":"UBERON:0000033_1",
        //    "MDB_UIAP_0000000527": "head",
        //    "label_class": "[UBERON: head]",
        //    "URI_class": "http://purl.obolibrary.org/obo/UBERON_0000033",
        //    "MDB_DATASCHEME_0000002429": "/img/icon_description_property_MDB_GUI_0000000496.jpg",
...
MDBControllers.controller('EntrySpecCtrl', function ($scope, $rootScope, $log, $http, $location, $cookies, AuthService, NotificationService, $uibModal, WsService, MDBDocumentService) {
    ...
    $scope.loadMDBEntry = function (mdb_entry_id) {
        ...
        var value = "";
        var key_data = [];
        WsService.sendCheckInputToWebsocket(mdb_entry_id, "MDB_DATASCHEME_0000002090", value, key_data, $scope.cookies['currentUEID'], null);
    };
    ...
    $scope.loadingButton = angular.element(document.getElementById('MDB_DATASCHEME_0000000695'));
...
MDBControllers.controller('EntryDescCtrl', function ($scope, $rootScope, $log, $http, $location, $cookies, AuthService, NotificationService, $uibModal, WsService, MDBDocumentService) {
    ...
    $scope.loadingButton = angular.element(document.getElementById('MDB_DATASCHEME_0000002104'));
    if ( document.getElementById('loadingExcuse') !== null ) {
        document.getElementById('loadingExcuse').style.display = 'none';
    }
...
// initial values for Auth and Cookies
    ...
    //WsService.sent[0] = {
    //    "type": "check_input",
    //    "localID": "MDB_DATASCHEME_0000002090",
    //    "mdbueid": "421701d8",
    //    "mdbueid_uri": "",
    //    "html_form": "de46dd64-20170705-s-2-d_1_1#MDB_CORE_0000000412_1",
    //    "connectSID": "s:42-HALLOHIERALARMEINS1ELF-TTESTT.SANDRASGANZPERSOENLICHEMDBPROTOTYPSESSIONID",
    //    "localIDs": [],
    //    "http://www.morphdbase.de/Ontologies/MDB/MDB_GUI#MDB_GUI_0000000411": "#TimeInterval_1",
    //    "http://www.morphdbase.de/Ontologies/MDB/MDB_GUI#MDB_GUI_0000000412": "#MDB_CORE_0000000568_1"
    //}
    ...
    if ($scope.entry_Id){
        var value = " ";
        var key_data = [];
        var mdb_entry_id = $scope.entry_Id + "#MDB_CORE_0000000412_1";
    ...
    // "de46dd64-20170131-s-7-d_1_1#MDB_CORE_0000000412_1"
    // "6cc9ca2f-20170106-s-3-d_1_1#MDB_CORE_0000000412_1"
    // "de46dd64-20170208-s-16-d_1_1#MDB_CORE_0000000412_1"
    // "de46dd64-20170619-s-2-d_1_1#MDB_CORE_0000000412_1"
    // "de46dd64-20170619-s-9-d_1_1#MDB_CORE_0000000412_1"
    // "de46dd64-20170621-s-7-d_1_1#MDB_CORE_0000000412_1"
    // "de46dd64-20170623-s-7-d_1_1#MDB_CORE_0000000412_1"
    // "de46dd64-20170630-s-8-d_1_1#MDB_CORE_0000000412_1"
    // "de46dd64-20170705-s-1-d_1_1#MDB_CORE_0000000412_1"
    //$scope.WsService.sendCheckInputToWebsocket("de46dd64-20170705-s-1-d_1_1#MDB_CORE_0000000412_1", "MDB_DATASCHEME_0000002090", "", [], $scope.cookies['currentUEID']);
...
// initial values for Auth and Cookies
    ...
    // "6cc9ca2f-20170106-s-3-d_1_1#MDB_CORE_0000000412_1"
    // "de46dd64-20170208-s-16-d_1_1#MDB_CORE_0000000412_1"
    //$scope.WsService.sendCheckInputToWebsocket("de46dd64-20170208-s-16-d_1_1#MDB_CORE_0000000412_1", "MDB_DATASCHEME_0000002090", "", [], $scope.cookies['currentUEID']);
