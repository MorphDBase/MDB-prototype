 ...
 * Last modified by Roman Baum on 03.01.17.
 */

package mdb.packages;

import mdb.basic.ExecutionStep;
...
public class KBOrder {
    ...
    private void createKBOrder(JenaIOTDBFactory connectionToTDB, String pathToOntologyTDB, String mdbStatusTransitionString) {
        ...
        if (urlValidator.isValid(mdbStatusTransitionString)) {
            ...
            tripleSPO.addWhere("?s", "<http://www.w3.org/2002/07/owl#annotatedSource>", "<" + mdbStatusTransitionString + ">");
        ...
        while (resultIterator.hasNext()) {
            ...
            if ((!currProperty.contains("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"))
                    & (!currProperty.contains("http://www.w3.org/2002/07/owl#annotatedSource"))
                    & (!currProperty.contains("http://www.morphdbase.de/Ontologies/MDB/MDBUserInterfaceAnnotationProperty#MDB_UIAP_0000000011"))) {

                String currSubject = currStmt.getSubject().toString();
                String currObject = currStmt.getObject().toString();

                if ((currProperty.contains("http://www.w3.org/2002/07/owl#annotatedTarget"))
                ...
                } else if (currProperty.equals("http://www.w3.org/2002/07/owl#annotatedProperty")) {
